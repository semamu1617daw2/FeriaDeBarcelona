...
public class BDAccessor {
    ...
    private void assignarPropietatsBD() throws IOException {
        ...
        try {
            propietats = carregarParametres(System.getProperty("user.dir") + "/database.properties");
            //propietats = carregarParametres(System.getProperty("user.dir") + "/src/Teoria/database.properties");
            //"/home/semamu/Documentos/DAW2/M03-Programacio_orientada_objectes/Java/NetBeans/09-03-2017-JDBC/database.properties"
